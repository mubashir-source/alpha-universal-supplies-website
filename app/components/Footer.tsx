        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Our secure online donation platform allows you to make contributions quickly and safely. Choose from various payment methods to donate.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/category" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Products / Categories
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">+000 (123) 642-27-10</p>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-blue-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <p className="text-gray-300 text-sm">example@email.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-[90%] mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-center items-center space-y-4 md:space-y-0">
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-center">
              <p className="text-gray-400 text-sm text-center">© 2025 Alpha Universal Supplies. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
